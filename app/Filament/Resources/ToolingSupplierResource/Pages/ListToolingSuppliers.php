...
use App\Imports\ToolingSupplierImport;
...
class ListToolingSuppliers extends ListRecords
{
            ...
            Actions\Action::make('import')
                ...
                ->form([
                    FileUpload::make('file')
                        ...
                        ->required()
                        ->helperText('Required headers: part_no, tooling_price, depre_per_pcs. Optional: status (active/inactive, default: active)'),
                ])
                ->action(function (array $data) {
                    try {
                        ...
                        Excel::import(new ToolingSupplierImport(), $filePath);

                        Notification::make()
                            ->title('Import Successful')
                            ->success()
                            ->body('Tooling Supplier data has been imported successfully.')
                            ->send();
                    } catch (\Exception $e) {
                        Notification::make()
                            ->title('Import Failed')
